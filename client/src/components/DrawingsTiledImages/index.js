    ...
    <div className="tiles">
        <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
            <Col className="gutter-row" span={12}>
                <Div>
                    <img src={require('../../img/fleurs.jpeg')} alt=" "></img>
                    <Div2>
            ...
            <Col className="gutter-row" span={12}>
                <Div>
                    <img src={require('../../img/girlatcafe.jpg')} alt=" "></img>
                    <Div2>
                        <p>girl at cafe</p>
                        <p>ink and gouache on paper</p>
        ...
        <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
            <Col className="gutter-row" span={12}>
                <Div>
                    <img src={require('../../img/girlsitting2019.jpeg')} alt=" "></img>
                    <Div2>
                        <p>girl sitting</p>
                        <p>ink and gouache on paper</p>
            ...
            <Col className="gutter-row" span={12}>
                <Div>
                    <img src={require('../../img/girlwithfruit.jpeg')} alt=" "></img>
                    <Div2>
        ...
        <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
            <Col className="gutter-row" span={12}>
                <Div>
                    <img src={require('../../img/girlinpool2019.jpg')} alt=" "></img>
                    <Div2>
                        <p>girl in pool</p>
                        <p>ink and gouache on paper</p>
            ...
            <Col className="gutter-row" span={12}>
                <Div>
                    <img src={require('../../img/jaroflilliesandpoppies.jpg')} alt=" "></img>
                    <Div2>
        ...
        <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
            <Col className="gutter-row" span={12}>
                <Div>
                    <img src={require('../../img/stilllifeofvases.jpeg')} alt=" "></img>
                    <Div2>
                        <p>study of vases</p>
                        <p>ink and gouache on paper</p>
            ...
            <Col className="gutter-row" span={12}>
                <Div>
                    <img src={require('../../img/summerroses2020.jpg')} alt=" "></img>
                    <Div2>
                        <p>summer roses</p>
                        <p>ink and gouache on paper</p>
                        {/* <a className="info-link" href="#" target="_blank">www.etsylink.com</a> */}
